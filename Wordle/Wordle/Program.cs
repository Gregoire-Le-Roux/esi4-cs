    ...
    static void Main(string[] args)
    {
        ...
        void VoirLesScores()
        {
            ...
            while (menu != -1)
            {
                ...
                Console.WriteLine("\n1.Exporter les scores dans un fichier txt");
        ...
        // Export des scores dans un fichier txt
        void ExportScores()
        {
            string[] str = new string[]
             {
                   "Mes Scores",
                   $"1 mot: {meilleurScoreUnePartie} essais",
                   $"5 mots: {meilleurScoreCinqParties} mots",
                   $"Jusqu'à perdre: {meilleurScoreInfini} mots",
             };

            using (StreamWriter sw = new StreamWriter("MesScores.txt"))
            {
